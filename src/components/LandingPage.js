  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost/funeraria/api/components/contact_submit.php",
        {
          method: "POST",
          headers: {
      ...
      <nav className="bg-gray-700/95 backdrop-blur-sm text-white py-4 px-6 shadow-lg relative z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <img
              src="/assets/gomez_logo-removebg-preview.png"
              alt="Gomez Logo"
              className="h-12 w-12"
            />
            ...
            <div>
              <h1 className="text-xl font-semibold">
                Funeraria Gomez - Udtohan
              </h1>
              <p className="text-xs text-gray-300">
                Online Funeral Services System
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center text-center text-white">
              <div className="max-w-4xl">
                ...
                <p className="text-xl md:text-2xl text-gray-200 mb-12 font-light leading-relaxed max-w-3xl mx-auto">
                 “Our online funeral services system helps you handle every part of the memorial service with dignity and respect.”
                </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We provide complete funeral management solutions to help you honor
              your loved ones with dignity and ease.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group bg-gray-50 rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Comprehensive planning tools for funeral services, memorials,
            ...
            <div className="group bg-gray-50 rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Assistance with all necessary paperwork, permits, and legal
                documentation.
              </p>
            </div>
            ...
            <div className="group bg-gray-50 rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Compassionate guidance and support for family members during
                difficult times.
              </p>
            </div>
            ...
            <div className="group bg-gray-50 rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Access to counseling services and resources for grief management
                and healing.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                For over 25 years, we've been helping families navigate the
                difficult journey of saying goodbye to loved ones. Our
                compassionate team understands the importance of honoring a life
                well-lived.
              </p>
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Our funeral management system was developed with input from
                funeral directors, grief counselors, and families to ensure it
                meets the needs of everyone involved in the memorial process.
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <button
                  className="bg-gray-800 hover:bg-gray-900 text-white py-4 px-8 rounded-lg transition-all duration-300 shadow-lg text-lg font-medium"
                  onClick={handleStory}
                >
                  Our Story
                </button>
      ...
      <section id="testimonials" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Hear from families who have used our funeral management services
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 italic text-lg leading-relaxed">
                "During our family's difficult time, Gomez Funeraria made the
                process seamless and respectful. Their organization and
                compassion were invaluable."
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 italic text-lg leading-relaxed">
                "The management system simplified all the complicated paperwork
                and planning. It allowed us to focus on celebrating my father's
                life instead of administrative tasks."
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 italic text-lg leading-relaxed">
                "I was overwhelmed until we found Gomez Funeraria. Their
                guidance and support through every step of planning my mother's
                memorial was a blessing."
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-800 to-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl text-gray-100 mb-12 max-w-3xl mx-auto leading-relaxed">
            Our dedicated team is available 24/7 to help you navigate funeral
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <button
              className="border-2 border-white hover:bg-white hover:text-gray-800 text-white py-4 px-10 rounded-lg transition-all duration-300 font-semibold text-lg"
              onClick={handleNavigate}
            >
              View Our Services
            </button>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              We're available 24/7 to provide support and answer any questions
              you may have.
            </p>
          </div>
      ...
      <footer className="bg-black text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p className="text-lg">
              © {new Date().getFullYear()} Funeraria Gomez - Udtohan. All rights
              reserved.
            </p>
          </div>
        </div>
